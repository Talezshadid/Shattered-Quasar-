...
namespace AnyRadiance
{
    internal static class ArenaInfo
    {
        ...
        private const float A2Left = 50;
        private const float A2Right = 70;
        private const float A2CenterX = 60;
        private const float A2Width = A2Right - A2Left;
        private const float A2Top = 48;
        private const float A2Bottom = 36;
        private const float A2Height = A2Top - A2Bottom;

        public const float A3Left = 55;
        public const float A3Right = 71;
        public const float A3CenterX = A3Left + (A3Right - A3Left) / 2;
        public const float A3Width = A3Right - A3Left;
        public const float A3Top = 157;
        public const float A3Bottom = 60;
