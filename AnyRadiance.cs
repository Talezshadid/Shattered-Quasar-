...
namespace AnyRadiance
{
    internal class AnyRadiance : Mod, ILocalSettings<LocalSettings>, IMenuMod
    {
        ...
        public AnyRadiance() : base("SHATTERED QUASAR") { }
            ...
            switch (key)
            {
                case "ABSOLUTE_RADIANCE_SUPER":
                    return PlayerData.instance.statueStateRadiance.usingAltVersion ||
                        ...
                        ? "Eternal Shattered"
                        : orig;
                case "ABSOLUTE_RADIANCE_MAIN": return ("quasar");      
                case "ANY_RAD_NAME":
                    return "Shattered Quasar";
                case "ANY_RAD_DESC":
                    return "Weakened form of the strongest deity.";
                case "GODSEEKER_ANYRAD_STATUE":
                    return sheetTitle == "CP3" ? "Okay. \n Reload from main menu to play again." : orig;
            }
        ...
        public List<IMenuMod.MenuEntry> GetMenuData(IMenuMod.MenuEntry? menu)
        {
            return new List<IMenuMod.MenuEntry>
            {
                ...
                {
                    Name = "In Pantheon?",
                    Description = "Choose whether Shattered Quasar shows up in the Pantheon of Hallownest.",
