...
namespace AnyRadiance.Radiance
{
    internal class Splitter : MonoBehaviour
    {
        ...
        private float _minScale = 10f;
        private float _trackingAcceleration = 15f;
        private float _maxTrackingSpeed = 12;
        private float _scale = 2;
        private float _maxSpeedIncrease = 2;
        private float _trackAccelIncrease = 15f;
        ...
        private IEnumerator Split(float delay)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                smallerOrb.transform.localScale = Vector3.one * _scale / 4;
