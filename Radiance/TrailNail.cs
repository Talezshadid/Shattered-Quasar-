...
namespace AnyRadiance.Radiance
{
    ...
    {
        public float PreTravelPause = 20f;
        public float RotateTime = 10;
        public float TravelSpeed = 10;
        public float TravelTime = 20;
        ...
        private void Awake()
        {
            ...
            GetComponent<DamageHero>().damageDealt = 3;
            ...
            _idlePt.gameObject.AddComponent<DamageOnParticleCollision>().Damage = 3;
        }
