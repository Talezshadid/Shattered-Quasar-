...
namespace AnyRadiance.Radiance
{
    internal class Radiance : MonoBehaviour
    {
        ...
        private const int NumPlatsA2 = 6;
        private const int NumPlatsAscend = 15;
        private const float FinalPhaseY = 153;
#if DEBUG
        private const int Phase1HP = 1750;
        ...
        private static readonly ActionSequence _summonSplitterP1 = new()
        {
            ...
            Actions = new Action[]
            {
                new SummonSplitter(1f, 1f, 2f, 8, 2, 2, 1.5f, 6),
            }
        };
        ...
        private static readonly ActionSequence _summonBeamOrbP1 = new()
        {
            ...
            Actions = new Action[]
            {
                new SummonBeamOrb(true, false, 32, 0.25f, 0.1f, 1, 0.5f, 2),
            }
        };
        ...
        private static readonly ActionSequence _summonBeamOrbP2 = new()
        {
            ...
            Actions = new Action[]
            {
                new SummonBeamOrb(true, true, 39, 0.1f, 5, 3, 1f, float.MaxValue, true),
            }
        };
        ...
        private static readonly ActionSequence _summonSplitterP2 = new()
        {
            ...
            Actions = new Action[]
            {
                new SummonSplitter(3.1f, 14f, 2, 8, 2, 2, 2, 2),
            }
        };
        ...
        private void GetChildren()
        {
            ...
            AnyRadiance.Instance.GameObjects["Abyss Pit"].GetComponentInChildren<DamageHero>().damageDealt = 1;
        ...
        private IEnumerator StartPhase3()
        {
            ...
            AnyRadiance.Instance.GameObjects["Abyss Pit"].GetComponentInChildren<DamageHero>().damageDealt = 3;
        ...
        private IEnumerator ChooseAttackP1()
        {
            ...
            if (_healthManager.hp <= Phase1HP / 2.3)
            {
